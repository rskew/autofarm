...
% ecron_server:add_cronjob(water_tommies, "30 17 * * *", {irrigation_controller, activate_solenoid, [0, 6, 1800]}).
% ecron_server:add_cronjob(water_cucs_zucs, "0 17 * * *", {irrigation_controller, activate_solenoid, [0, 5, 1800]}).
